...
public class Client implements ActionListener{
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Icons\\Clientpfp.png"));
        Image i5 = i4.getImage().getScaledInstance(60, 70, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel profile = new JLabel(i6);

        profile.setBounds(40, 3, 60, 70);
        // Adding this imageicon on the panel
        p1.add(profile);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true) {
                ...
                // left.setBackground(new Color(197, 118, 246));
                vertical.add(left);
                // vertical.setBackground(new Color(197, 118, 246));
                vertical.add(Box.createVerticalStrut(15));
                a1.add(vertical, BorderLayout.PAGE_START);
                f.validate();
